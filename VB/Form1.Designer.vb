...
#End Region
        Private myBarManager1 As WindowsApplication1.MyBarManager
        ...
        Private myBarButtonItem1 As WindowsApplication1.MyBarButtonItem

        Private myBarButtonItem2 As WindowsApplication1.MyBarButtonItem
